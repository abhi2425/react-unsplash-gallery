...
const NavBar = () => {
  ...
  return (
    <AppBar style={{backgroundColor:'var(--color-bg)'}} sx={{ zIndex: 10, py: 2.3, px: 5, }} position='fixed'>
      <CssBaseline />
      <div className='flex-x-between'>
        ...
        <FormControlLabel
          ...
          value='start'
          control={<Switch color='primary' onChange={toggleHandler} checked={theme==='dark-theme' &&true} />}
          label={
